...
DAO = TodoDAO()
DAO.create({'title': 'build an API', 'order': 1, 'completed': False})
DAO.create({'title': '?????', 'order': 2, 'completed': False})
DAO.create({'title': 'profit!', 'order': 3, 'completed': False})
